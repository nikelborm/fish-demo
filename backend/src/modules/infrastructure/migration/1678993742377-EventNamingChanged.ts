...
export class EventNamingChanged1678993742377 implements MigrationInterface {
    name = 'EventNamingChanged1678993742377'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "event"
            ADD CONSTRAINT "FK_b966ddf4f5772104155218035a6" FOREIGN KEY ("event_type_id") REFERENCES "event_type"("event_type_id") ON DELETE
